...
RDEPEND="
	crypt? ( =dev-libs/crypto++-5.6.5-r1 )
	dev-db/sqlite
	fuse? ( sys-fs/fuse )
...
PATCHES=(
	"${FILESDIR}/urbackup-server-2.2.8-autoupdate-code.patch"
	"${FILESDIR}/urbackup-server-2.2.8-autoupdate-config.patch"
	"${FILESDIR}/urbackup-server-2.2.8-autoupdate-ui.patch"
	"${FILESDIR}/urbackup-server-2.2.8-autoupdate-datafiles-gcc-fortify.patch"
)
