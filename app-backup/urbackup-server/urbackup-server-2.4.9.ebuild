...
PATCHES=(
	"${FILESDIR}/urbackup-server-2.4.9-autoupdate-code.patch"
	"${FILESDIR}/urbackup-server-2.4.9-autoupdate-config.patch"
	"${FILESDIR}/urbackup-server-2.4.9-autoupdate-ui.patch"
	"${FILESDIR}/urbackup-server-2.4.9-autoupdate-datafiles-gcc-fortify.patch"
)
